      ...
      <>
        <AnimatePresence>
          <div className="w-full flex flex-col items-center justify-center p-8 bg-coffee-400">
            ...
            <form action="/email" method="POST" className="w-full flex flex-col items-center justify-center" enctype="multipart/form-data" id="form-email">
              ...
              >
                ...
                <input type="text" class="border-coffee-500 bg-coffee-50 w-full"
              ...
              >
                ...
                <input type="email" class="border-coffee-500 bg-coffee-50 w-full"
              ...
              >
                ...
                <textarea type="text" class="border-coffee-500 bg-coffee-50 w-full"
                    id="message" name="message" placeholder="Enter your message..." rows="3"></textarea>
              </motion.div>
              <motion.div
                className="w-1/2 bg-coffee-200 mt-4"
                initial={{ opacity: 0, x: -200 }}
                whileInView={{ opacity: 1, x: 0 }}
                transition={{ ease: "easeOut", duration: 1 }}
                viewport={{ once: false, amount: 0.8 }}
