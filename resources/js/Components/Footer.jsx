...
export default function Footer(props) {
  return (
      <>
        <div className="w-full bg-coffee-tan">
          <div className="max-w-[1200px] flex flex-col md:flex-row md:divide-x-4 divide-coffee-900 mx-auto">
          ...
          <div className="items-center justify-between duration-500 transition-all m-auto" id="navbar-sticky">
            <ul className="flex flex-row p-4 mt-4 rounded-lg bg-transparent md:flex-col md:space-y-2 md:mt-0 md:text-md md:font-medium md:border-0">
              ...
              {/* <li>
                ...
                <li>
                  <Anchor text="Admin Login" url="/admin/login" type="footer" refresh="fullPage"/>
                </li>
                {/* <li>
          ...
          <div className="bg-coffee-700 mt-4 sm:mt-0">
