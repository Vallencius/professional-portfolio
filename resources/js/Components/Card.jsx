  ...
  return (
    <div className={"group relative h-full w-full max-w-sm shadow-lg bg-gradient-to-b from-transparent to-"+props.color+"-100 rounded-md bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-10 border border-gray-100"}>
      <a href={"/projects/"+props.project_info.slug}>
        <img className="p-4 z-0 group-hover:opacity-20" src={props.image } alt="" />
        ...
        <div className={"block lg:hidden lg:-z-10 absolute bottom-0 z-10 bg-gradient-to-b from-[rgba(0,0,0,0.2)] group-hover:block w-full h-full to-"+props.color+"-100 via-"+props.color+"-50"}>
